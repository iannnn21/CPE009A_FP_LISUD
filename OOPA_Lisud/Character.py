...
character1 = Character("Blee")
print (character1.getUsername())

##The print(character1.__username) will trigger an Attribute error because of the underscored python has made the variable private meaning you cant directly access character    